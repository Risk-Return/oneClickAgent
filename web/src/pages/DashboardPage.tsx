        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {jobsLoading ? (
              ...
              <p className="text-sm text-muted-foreground">No jobs yet. Submit your first one!</p>
            ) : (
              recentJobs.map((job) => (
            ...
            <Link to="/history">
              <Button variant="outline" size="sm" className="w-full">
                <Clock className="mr-2 h-4 w-4" /> View all jobs
              </Button>
            </Link>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-3">
            <Link to="/jobs">
              <Button className="w-full">
                <Terminal className="mr-2 h-4 w-4" /> New Command
              </Button>
            </Link>
            <Link to="/agents">
              <Button variant="outline" className="w-full">
                <Bot className="mr-2 h-4 w-4" /> View Agents
              </Button>
            </Link>
          </CardContent>
        </Card>
